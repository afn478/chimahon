...
object LocaleHelper {
    ...
    fun getSourceDisplayName(lang: String?, context: Context): String {
        ...
        // SY <--
        return when (lang) {
            SourceListGroupingPolicy.LAST_USED_KEY -> context.stringResource(MR.strings.last_used_source)
            SourceListGroupingPolicy.PINNED_KEY -> context.stringResource(MR.strings.pinned_sources)
